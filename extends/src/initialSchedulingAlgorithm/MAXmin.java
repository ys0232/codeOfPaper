 ...
 */
public class MAXmin {
    public static void MaxMin(int processorNums, int taskNums, double beta, int priceModel,
    ...
    public static void main(String[] args)throws IOException{
        ...
        MaxMin(processorNum, taskNums, beta, pricelModel,computationCostPath, inputGraphPath, processorInfor);
