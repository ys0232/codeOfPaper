 ...
 */
public class MET {
    public static void Met(int processorNums, int taskNums, double beta, int priceModel,
    ...
    public static void main(String[] args) throws IOException {
        ...
        Met(processorNum, taskNums, beta, pricelModel, computationCostPath, inputGraphPath, processorInfor);
