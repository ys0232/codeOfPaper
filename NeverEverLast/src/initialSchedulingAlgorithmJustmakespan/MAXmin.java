 ...
 */
public class MAXmin {
    public static double MaxMinMakespan(int processorNums, int taskNums, double beta, int priceModel,
    ...
    public static void main(String[] args) throws IOException {
        ...
        MAXmin.MaxMinMakespan(processorNum, taskNums, beta, pricelModel, computationCostPath, inputGraphPath, processorInfor, 1.5, 0);
