 ...
 */
public class MET {
    public static double MetMakespan(int processorNums, int taskNums, double beta, int priceModel,
        ...
        HashMap<Integer, String> schedulerList=METS(processorNums, taskNums, taskList, taskEdgeHashMap, processorsArray);
        ...
        public static HashMap<Integer, String> METS(int processorNums, int taskNums, ArrayList<Task> taskList, HashMap<java.lang.String, Double> taskEdgeHashMap,
            ...
            while (unscheduledNum > 0) {
                ...
                //    System.out.println(taskid+"\t"+!unscheduledTask[taskid]+"\t"+(task.predecessorTaskList.size() - completedParent[taskid]));
                  ...
                  //  System.out.println(taskMinCTime[taskid]+"\t"+i+"\t"+schedPro.availableTime+"\t"+proMinCTime[taskid]);
    ...
    public static void main(String[] args) throws IOException {
        ...
        MetMakespan(processorNum, taskNums, beta, pricelModel, computationCostPath, inputGraphPath, processorInfor,1.6,0);
